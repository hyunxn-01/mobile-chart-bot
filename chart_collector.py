...
AXIS_PV = 'v10-brief3'   # 브리핑 프롬프트 버전(바꾸면 캐시 무효화·전 시장 1회 재생성). v9: 두괄식·섹션명 실무화·짧은 문장·요약+세부·대시 금지
...
def _axis_prompt(scope_label, axis_label, digest, is_region, grounded=False, prior_note=''):
    ...
    return (f"다음은 App Store 게임 '매출' 차트의 '{scope_label}' {axis_label} 스냅샷·추이다.\n\n"
            ...
            "각 항목은 '## 제목' 한 줄로 시작하고, 그 아래 불릿(-)으로 쓴다. 각 항목 첫 불릿='요약'(그 항목 분석의 핵심을 한 줄로 압축. 막연한 주제문 금지, 실제 시장·장르·게임·수치를 콕 집어 개조식 키포인트로. 예: '한국 MMORPG · 북미 캐주얼 퍼즐·보드 · 일본 가챠 RPG·스포츠 시뮬'). 이후 1~2개 불릿='분석'(그 근거·맥락, 요약과 중복 없이). 요약만 훑어도 알맹이가 잡히게. 항목 제목은 그대로 둘 것.\n"
            "## 시장 구조\n## 주요 게임·퍼블리셔\n## 주요 순위 변동\n## 장르 기회\n## 핵심 시사점\n\n"
